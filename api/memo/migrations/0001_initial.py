# Generated by Django 4.1.3 on 2022-12-04 00:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='memo.post')),
            ],
        ),
        migrations.CreateModel(
            name='Topic',
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='memo.topic'),
        ),
    ]
